// build.mjs — ASV Verse-per-Page static site builder (v1.3 Alpha, with hubs + sitemap index + jump selectors)
...
const CNAME = process.env.CNAME || "asv.the-holy-bible.online";
...
${JSON.stringify({
  ...
  "@type": "CreativeWork",
  "name": `${bookName} ${chapter}:${verse} (ASV)`,
  "isPartOf": { "@type":"CreativeWorkSeries", "name":"The Holy Bible — American Standard Version" },
  "inLanguage":"en",
  "url": can
})}
</script>
...
<header class="site-head">
  <a class="brand" href="https://www.livingwordbibles.com/read-the-bible-online/asv" aria-label="Living Word Bibles — Read the Bible Online (ASV)">
    <img class="logo" alt="Living Word Bibles" src="${LOGO_URL}">
  </a>
  <div class="brand-titles">
    <div class="brand-h1">The Holy Bible</div>
    <div class="brand-h2">American Standard Version</div>
  </div>
  <nav class="site-nav">
...
<title>The Holy Bible (ASV) — Verse by Verse</title>
${FONT_LINK}
...
<body>
<header class="site-head">
  <a class="brand" href="https://www.livingwordbibles.com/read-the-bible-online/asv" aria-label="Living Word Bibles — Read the Bible Online (ASV)"><img class="logo" alt="Living Word Bibles" src="${LOGO_URL}"></a>
  <div class="brand-titles">
    <div class="brand-h1">The Holy Bible</div>
    <div class="brand-h2">American Standard Version</div>
  </div>
...
<main class="container">
  <p class="welcome">Welcome! God Bless! The Holy Bible Online presents the American Standard Version verse-by-verse for maximum readability.</p>
...
<meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>Not Found — The Holy Bible (ASV)</title>
${FONT_LINK}
<link rel="stylesheet" href="/assets/styles.css">
</head><body>
...
function bookIndexHTML(bookName, slug, chaptersCount) {
  ...
  return `<!DOCTYPE html><html lang="en"><head>
<meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>${bookName} (ASV) — Chapter Index</title>
${FONT_LINK}<link rel="stylesheet" href="/assets/styles.css">
<link rel="canonical" href="${SITE}/${slug}/">
<meta name="robots" content="index,follow">
</head><body>
<header class="site-head">
  <a class="brand" href="https://www.livingwordbibles.com/read-the-bible-online/asv"><img class="logo" alt="Living Word Bibles" src="${LOGO_URL}"></a>
  <div class="brand-titles"><div class="brand-h1">The Holy Bible</div><div class="brand-h2">American Standard Version</div></div>
...
function chapterIndexHTML(bookName, slug, chapter, versesCount){
  ...
  return `<!DOCTYPE html><html lang="en"><head>
<meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1">
<title>${bookName} ${chapter} (ASV) — Verse Index</title>
${FONT_LINK}<link rel="stylesheet" href="/assets/styles.css">
...
// Try to load a Books.json if present; otherwise derive from OT+NT.
async function loadIndex(){
  try {
    const names = await loadJSON("Books.json");
    return names;
  } catch {
    return [...OT, ...NT]; // derive if no Books.json in the data source
  }
}

async function loadBook(slug, name){
  const raw = await loadJSON(fileFromName(name)); // e.g., Genesis.json, SongofSolomon.json
...
// include /book/ and /book/chapter/ hubs in sitemaps with lastmod
...
async function buildAll(){
  ...
  for (const name of [...OT, ...NT]){
    if (!nameSet.has(name)) {
      console.warn(`Warning: ${name} missing from Books.json — attempting fetch by filename anyway`);
    }
    const slug = slugify(name);
  ...
  const byBook = urlsByBook(refs, books);
